...
window.addEventListener('DOMContentLoaded', (event) => {
  ...
  if(electronicMessage) {
    electronicMessage.classList.remove('fallbackUnlink');
    
    electronicMessage.onclick = function() {
      electronicMessage.href = 'mailto:' + atob(electronicMessage.dataset.href);
      electronicMessage.innerHTML = atob(base64);
    };      
  }  
